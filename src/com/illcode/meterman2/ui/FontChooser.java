 ...
 *
 * Based on https://stackoverflow.com/a/7528129/84923
 *    which in turn uses the code from
 * https://osdn.net/projects/jfontchooser/
 ************************************************************/
...
final class FontChooser extends JComponent
{
    ...
    protected JTextArea getSampleTextField() {
        if (sampleText == null) {
            ...
            sampleText = new JTextArea("(type sample text here)");
